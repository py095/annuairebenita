...
class _FabCircularMenuState extends State<FabCircularMenu>
  ...
  void didChangeDependencies() {
    ...
    rotateAnimation = Tween<double>(begin: 1.0, end: 30.0)
        .animate(rotateCurve)
      ..addListener(() {
        setState(() {});
      });
  ...
  Widget build(BuildContext context) {
    final double bottom = -(scaleAnimation.value * ringDiameter / 2 - 10.0 - (widget.fabMargin.bottom / 2));
    final double right = -(scaleAnimation.value * ringDiameter / 2 - 10.0 - (widget.fabMargin.right / 2));
    return Stack(
